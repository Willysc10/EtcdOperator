...
#[derive(Debug)]
pub struct EtcdOperatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EtcdOperatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EtcdOperator processing");
    
    let mut processor = EtcdOperatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EtcdOperatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EtcdOperatorProcessor::new(false);
